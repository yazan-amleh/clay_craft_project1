...
import 'package:clay_craft_project/seventeenth_page.dart';
import 'package:clay_craft_project/sixteenth_page.dart';
import 'fourteenth_page.dart';
    ...
    return Padding(
      ...
      child: TextField(
        decoration: InputDecoration(
          hintText: "Get your pottery course ",
      ...
      onTap: () {
        if (title == "Functional Pottery") {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  FourteenthPage(potteryItems: functionalPotteryItems),
            ),
          );
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const SeventeenthPage()),
          );
        }
      },
      child: ClipRRect(
